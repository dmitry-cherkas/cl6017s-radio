...
void CL6017S::_readRegisters(uint8_t count)
{
...
void CL6017S::seekUp(void(*seekProgress)(uint16_t currentFrequency))
{
...
void CL6017S::seekDown(void(*seekProgress)(uint16_t currentFrequency))
{
    if (_isSeeking) return;
    _isSeeking = true;
    _setRegisterBit(RADIO_REG_CTRL, RADIO_REG_CTRL_TUNE, 0);
